...
namespace Loan_Buddy_Api.Migrations
{
    ...
    [Migration("20220817040543_adddata")]
            ...
            modelBuilder.Entity("Loan_Buddy_Api.Data.LoanAgreement", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            LoanAgreementId = 1,
                            BorrowerId = 1,
                            DateCreated = new DateTime(2022, 8, 16, 22, 5, 43, 6, DateTimeKind.Local).AddTicks(7636),
                            LenderId = 2,
            ...
            modelBuilder.Entity("Loan_Buddy_Api.Data.Transaction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            TransactionId = 1,
                            Amount = 55,
                            Date = new DateTime(2022, 8, 16, 22, 5, 43, 6, DateTimeKind.Local).AddTicks(7699),
                            LoanAgreementId = 1,
