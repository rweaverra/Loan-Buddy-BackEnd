...
namespace Loan_Buddy_Api.Migrations
{
    ...
    [Migration("20220817051711_adddata2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Loan_Buddy_Api.Data.LoanAgreement", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            LoanAgreementId = 1,
                            BorrowerId = 1,
                            DateCreated = new DateTime(2022, 8, 16, 23, 17, 11, 224, DateTimeKind.Local).AddTicks(8466),
                            LenderId = 2,
            ...
            modelBuilder.Entity("Loan_Buddy_Api.Data.Transaction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            TransactionId = 1,
                            Amount = 55,
                            Date = new DateTime(2022, 8, 16, 23, 17, 11, 224, DateTimeKind.Local).AddTicks(8619),
                            LoanAgreementId = 1,
            ...
            modelBuilder.Entity("Loan_Buddy_Api.Data.Transaction", b =>
                {
                    b.HasOne("Loan_Buddy_Api.Data.LoanAgreement", "LoanAgreement")
                        .WithMany()
