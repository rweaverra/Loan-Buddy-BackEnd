...
namespace Loan_Buddy_Api.Migrations
{
    ...
    [Migration("20220831184541_transactionupdate2")]
            ...
            modelBuilder.Entity("Loan_Buddy_Api.Models.LoanAgreement", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            LoanAgreementId = 1,
                            BorrowerId = 1,
                            DateCreated = new DateTime(2022, 8, 31, 12, 45, 40, 871, DateTimeKind.Local).AddTicks(3845),
                            LenderId = 2,
            ...
            modelBuilder.Entity("Loan_Buddy_Api.Models.Transaction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            TransactionId = 1,
                            Amount = 55,
                            Date = new DateTime(2022, 8, 31, 12, 45, 40, 871, DateTimeKind.Local).AddTicks(3914),
                            LoanAgreementId = 1,
                            ProofOfPaymentId = 0,
                            RemainingTotal = 2324,
