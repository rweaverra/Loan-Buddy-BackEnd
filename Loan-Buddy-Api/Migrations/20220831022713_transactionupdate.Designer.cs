...
namespace Loan_Buddy_Api.Migrations
{
    ...
    [Migration("20220831022713_transactionupdate")]
            ...
            modelBuilder.Entity("Loan_Buddy_Api.Models.LoanAgreement", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            LoanAgreementId = 1,
                            BorrowerId = 1,
                            DateCreated = new DateTime(2022, 8, 30, 20, 27, 12, 702, DateTimeKind.Local).AddTicks(8104),
                            LenderId = 2,
            ...
            modelBuilder.Entity("Loan_Buddy_Api.Models.Transaction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            TransactionId = 1,
                            Amount = 55,
                            Date = new DateTime(2022, 8, 30, 20, 27, 12, 702, DateTimeKind.Local).AddTicks(8151),
                            LoanAgreementId = 1,
                            ProofOfPaymentId = 0,
                            RemainingTotal = 2324,
